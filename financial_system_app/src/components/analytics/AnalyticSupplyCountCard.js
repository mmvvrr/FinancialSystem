...
import {fetchSupplyCountByYearQuery} from "@/hooks/api/analytics/fetchSupplyCountByYear";
...
const AnalyticProductsSaleCountCard = function (props) {
  ...
  const op = useRef(null);
    ...
    fetchSupplyCountByYearQuery(selectedYear.code)
    ...
    <div className='pt-3'>
      <div className='flex flex-row px-3 justify-content-between'>
        <div>
          ...
          <div className='text-xs'>Доставленных</div>
        </div>
        <Button
          type="button"
          text
