...
class Products(models.Model):
    ...
    id_category = models.ForeignKey(Categories, on_delete=models.SET_NULL, null=True, verbose_name=u"Категория")

class PriceManagments(models.Model):
    id_product = models.ForeignKey(Products, on_delete=models.CASCADE, null=True, verbose_name=u"Номер товара")
...
class Supplies(models.Model):
    id_provider = models.ForeignKey(Providers, on_delete=models.SET_NULL, null=True, verbose_name=u"Номер поставщика")
...
class Keeping(models.Model):
    id_storage = models.ForeignKey(Storages, on_delete=models.CASCADE, null=True, verbose_name=u"Номер склада")
    id_product = models.ForeignKey(Products, on_delete=models.CASCADE, null=True, verbose_name=u"Номер товара")
